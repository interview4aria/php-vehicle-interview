 ...
 */
final class Version20200822171456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sales_person_id INTEGER NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(20) NOT NULL COLLATE BINARY, color VARCHAR(255) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION DEFAULT NULL, description CLOB DEFAULT NULL, CONSTRAINT FK_1B80E4861D35E30E FOREIGN KEY (sales_person_id) REFERENCES sales_person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_1B80E4861D35E30E ON vehicle (sales_person_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__plane');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C1B32D80545317D1 ON plane (vehicle_id)');
        $this->addSql('DROP INDEX IDX_1B80E4861D35E30E');
